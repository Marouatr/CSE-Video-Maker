...
(function() {
    nexrender.selectLayersByName(null, 'pic1', function(layer) {
        nexrender.replaceFootage(layer, 'C:\\Users\\MAROUA\\AppData\\Local\\Temp\\nexrender\\6a8FsVTx-YFB9np9_Yuv5\\DSC_0805.jpg')
    });
})();

(function() {
    nexrender.selectLayersByName(null, 'Text A', function(layer) {

        var parts = ["Source Text"];
        var value = { "value": 'MEMORIES OF MAROUA' }
